...
let uniqueColorsArray = colors.filter(function(item, pos, self) {
...
let handleCLick = function () {
  // console.log('hi');
  rand = uniqueColorsArray[getRandomInt(uniqueColorsArray.length)];
  console.log(rand);
  console.log(invertColor(rand));
  r.style.setProperty('--second', invertColor(rand));
